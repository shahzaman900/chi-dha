    ...
    <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-slate-200 shadow-sm relative z-0">
      <div className="flex items-center gap-6">
        <h1 className="text-xl font-bold flex items-center gap-2 text-slate-800">
           <Archive className="h-6 w-6 text-brand-500" /> Patients
        </h1>
        <div className="w-[320px]">
          <Input 
            placeholder="Search patients..." 
            className="h-10 bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 focus-visible:ring-brand-500 rounded-full px-4" 
          />
        </div>
      </div>
      <div className="flex items-center gap-3">
        <Button 
          ...
          className="h-10 px-4 bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-full shadow-sm flex items-center gap-2 transition-all"
        >
        ...
        {selectedPatientId && (
          <Button 
            ...
            className="bg-brand-600 hover:bg-brand-700 text-white gap-2 ml-2"
          >
