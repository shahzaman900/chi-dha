    ...
    <div className="flex flex-col bg-white border-b border-slate-200 shadow-sm z-10 relative">
      ...
      <div className="flex h-12 items-center px-4 border-b border-slate-100 justify-between">
         ...
         <div className="flex items-center gap-4 text-slate-600 text-sm">
             ...
             <Users className="h-4 w-4 hover:text-brand-600 transition-colors cursor-pointer" />
             <Bell className="h-4 w-4 hover:text-brand-600 transition-colors cursor-pointer" />
             <MessageSquare className="h-4 w-4 hover:text-brand-600 transition-colors cursor-pointer" />
             <Avatar className="h-8 w-8 ring-2 ring-slate-100">
               <AvatarImage src="/avatar.png" alt="@user" />
               <AvatarFallback className="bg-brand-100 text-brand-700 font-semibold text-xs">SK</AvatarFallback>
             </Avatar>
         </div>
      </div>
      ...
      <div className="flex h-12 items-center px-4 gap-1 text-sm overflow-x-auto bg-slate-50/50">
        <Link href="#" className="flex items-center gap-2 px-3 py-1.5 rounded-md text-slate-600 hover:text-brand-700 hover:bg-brand-50 font-medium transition-colors">
          <LayoutGrid className="h-4 w-4" /> EWS
        </Link>
